...
class CraftingWorldEnvOneHot(gym.GoalEnv):
    ...
    def __init__(self, size=(STATE_W,STATE_H), fixed_init_state=0, max_steps=MAX_STEPS, store_gif=False, render_save_rate=1, task_list=TASK_LIST,
        ...
        self.observation_space = spaces.Dict(dict(observation=spaces.Box(low=0, high=1,
    ...
    def reset(self, render_next=False):
        ...
        self.obs_image = self.obs_one_hot
    ...
    def step(self, action):
        ...
        if changed_state == True:
            ...
            self.observation = {'observation': self.obs_one_hot, 'desired_goal': self.desired_goal,
                                'achieved_goal': self.obs_one_hot, 'init_observation': self.INIT_OBS}
